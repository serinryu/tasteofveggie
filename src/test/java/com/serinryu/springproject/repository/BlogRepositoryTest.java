...
public class BlogRepositoryTest {
    ...
    public void updateTest(){
        ...
        // then
        Assertions.assertEquals(blogId, blogJpaRepository.findById(blogId).get().getBlogId());
        Assertions.assertEquals(blogTitle, blogJpaRepository.findById(blogId).get().getBlogTitle());
        Assertions.assertEquals(blogContent, blogJpaRepository.findById(blogId).get().getBlogContent());
